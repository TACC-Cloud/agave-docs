...
..
   ...
   :information_source: A listing of all Agave's resource-level events, grouped by resource, can be found in the `Events <../events/introduction.md>`_ section.
